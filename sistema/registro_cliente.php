<?php
	...
	if(!empty($_POST))
	{
		...
		if($result > 0){
			...
			if($query_insert){
				$alert='<p class="msqg_save">Cliente guardado correctamente.</p>';
			}
			else{
				$alert='<p class="msqg_error">Error al guardar el cliente.</p>';
			}
		}			
...
<body>
	...
	<section id="container">
		...
		<form action="" method="post">
			...
			<input type="text" name="nit" id="nit" placeholder="Numero de DNI">
