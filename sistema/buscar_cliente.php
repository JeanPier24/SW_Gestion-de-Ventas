...
<body>
	...
	?>
		...
		<table>
			...
			<?php 
			//Paginador
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM cliente WHERE (
			...
			?>	
				...
				<td>
					...
					<a class="link_delete" href="eliminar_confirmar_clientes.php?id=<?php echo $data["idcliente"] ?>">Eliminar</a>
				<?php } ?>
				</td>
			</tr>	
