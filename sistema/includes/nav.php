<nav>
			<ul>
				<li><a href="index.php"><i class="fas fa-home"></i> Inicio</a></li>
					...
					<?php } ?>
				<li class="principal">
					<a href="#"><i class="fas fa-users-cog"></i> Clientes</a>
					<ul>
				...
				<li class="principal">
					...
					<ul>
						<li><a href="registro_proveedor.php"><i class="fas fa-building"></i> Nuevo Proveedor</a></li>
						<li><a href="lista_proveedor.php"><i class="fas fa-city"></i> Lista de Proveedores</a></li>
					</ul>
				</li>
