<?php 
	...
	if(!empty($_POST))
	{
		...
		if($result > 0){
			$alert='<p class="msqg_error">El DNI ya existe, volver a ingresar.</p>';
		}else{
			...
			if($sql_update){
				$alert='<p class="msqg_save"> Cliente actualizado correctamente.</p>';
			}
			else{
				$alert='<p class="msqg_error">Error al actualizar el cliente.</p>';
			}
		}
	}
...
<body>
	...
	<section id="container">
		...
		<form action="" method="post">
			...
			<input type="number" name="nit" id="nit" placeholder="Numero de DNI" value="<?php echo $nit; ?>">
