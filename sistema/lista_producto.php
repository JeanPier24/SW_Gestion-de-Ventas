		...
		<table>
			...
			$total_paginas = ceil($total_registro / $por_pagina);
				...
				$query = mysqli_query($conection, "SELECT p.codproducto, p.descripcion, p.precio, p.existencia, pr.proveedor, p.foto
												...
												WHERE p.estatus = 1 ORDER BY p.codproducto
			...
			?>	
				...
				<td>
					<a class="link_add add_product" style="margin-right: 15px" product="<?php echo $data["codproducto"]; ?>" href="#"><i class="fas fa-plus"></i> Agregar</a>
	

					<a class="link_edit" style="margin-right: 15px" href="editar_producto.php?id=<?php echo $data["codproducto"]; ?>"><i class="far fa-edit"></i> Editar</a>
