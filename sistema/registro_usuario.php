<?php
	...
	if(!empty($_POST))
	{
		...
		if($result > 0){
			$alert='<p class="msqg_error">El correo o el usuario ya existen.</p>';
		}
		else{
			include "../conexion.php";
			...
			if($query_insert){
				$alert='<p class="msqg_save">El usuario ha sido creado correctamente.</p>';
			}
			else{
				$alert='<p class="msqg_error">Error al crear el usuario.</p>';
			}
		}
		}
	}
