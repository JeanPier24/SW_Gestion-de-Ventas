	...
	<section id="container">
		...
		<table>
			...
			?>	
				...
				<td>
					<a class="link_edit" style="margin-right: 15px" href="editar_cliente.php?id=<?php echo $data["idcliente"] ?>"><i class="far fa-edit"></i> Editar</a>
						<?php if($_SESSION['rol'] == 1 ) {  ?>

					<a class="link_delete" href="eliminar_confirmar_clientes.php?id=<?php echo $data["idcliente"] ?>"><i class="far fa-trash-alt"></i> Eliminar</a>
					<?php } ?>
