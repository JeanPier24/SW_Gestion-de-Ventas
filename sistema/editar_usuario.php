<?php 
	...
	if(!empty($_POST))
	{
		...
		if($result > 0){
			$alert='<p class="msqg_error">El correo o el usuario ya existe.</p>';
		}
		else{
			...
			if($sql_update){
				$alert='<p class="msqg_save"> Usuario actualizado correctamente.</p>';
			}
			else{
				$alert='<p class="msqg_error">Error al actualizar el usuario.</p>';
			}
		}
	}
