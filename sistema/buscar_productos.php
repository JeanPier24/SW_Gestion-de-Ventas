...
if($total_paginas != 0){
	?>
		<div class="paginador">
			...
			<li><a href="?pagina=<?php echo $pagina + 1; ?>&<?php echo $buscar; ?>"><i class="fas fa-step-forward"></i></a></li>
			<li><a href="?pagina=<?php echo $total_paginas; ?>?>&<?php echo $buscar; ?>"><i class="fass fa-step-forward"></i></a></li>
			<?php } ?>
